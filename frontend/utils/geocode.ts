...
const LOCATION_TABLE: Record<string, LatLng> = {
  ...
  "south africa": { lat: -30.56, lng: 22.937 },
  zambia: { lat: -13.133, lng: 27.849 },
  malawi: { lat: -13.254, lng: 34.302 },
  rwanda: { lat: -1.94, lng: 29.874 },
  ...
  usa: { lat: 37.09, lng: -95.713 },
  "united states": { lat: 37.09, lng: -95.713 },
  "united states of america": { lat: 37.09, lng: -95.713 },
  alaska: { lat: 64.2, lng: -153.5 },
  ...
  asia: { lat: 34.047, lng: 100.62 },
  "central asia": { lat: 41.2, lng: 63.19 },
  ...
  // ── Ocean / Global ────────────────────────────────────────────────────────────
  "great barrier reef": { lat: -18.286, lng: 147.7 },
